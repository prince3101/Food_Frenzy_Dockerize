...
export class Dashboard extends Component {
  ...
  getDahboradData = async () => {
    try {
      const response = await axios.get("/admin/dashboard");
      console.log(response.data.payload);
      this.setState({ dashboard: response.data.payload });
    } catch (error) {}
  };
          ...
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-danger card-img-holder text-white">
              <div className="card-body">
                ...
                <h2 className="mb-5">{this.state.dashboard.user}</h2>
              </div>
            </div>
          </div>
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-info card-img-holder text-white">
              <div className="card-body">
                ...
                <h2 className="mb-5">{this.state.dashboard.bill}</h2>
              </div>
            </div>
          </div>
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-success card-img-holder text-white">
              <div className="card-body">
                ...
                <h2 className="mb-5">{this.state.dashboard.category}</h2>
              </div>
            </div>
          </div>
        </div>
